...
// forward declaration
void SeekForward2(int *ppixelsToSkip, int* pesi, char*bitmapBuf, int seekAmount);
...
void SeekForward2(/*out*/ int *ppixelsToSkip, /*inout*/ int* pesi, char*bitmapBuf, int seekAmount)
{
	int esi = *pesi;
	int al;
