...
void _stdcall IMGremapAreaHMirror(char*imageBuf,int pitch,int desX,int desY,char*bitmapPtr,unsigned char**colorTableArray,int srcX1,int srcY1,int srcX2,int srcY2)
{
