7, 7, 66, 26
Kingdoms Report
Click on this scroll or press F1 to bring up the Kingdoms Report.
Click on it again or press ESC to close it.
~
66, 6, 128, 24
Villages Report
Click on this scroll or press F2 to bring up the Villages Report.
Click on it again or press ESC to close it.
~
133, 6, 190, 24
Economy Report
Click on this scroll or press F3 to bring up the Economy Report.
Click on it again or press ESC to close it.
~
194, 6, 253, 23
Trade Report
Click on this scroll or press F4 to bring up the Trade Report.
Click on it again or press ESC to close it.
~
12, 27, 72, 44
Military Report
Click on this scroll or press F5 to bring up the Military Report.
Click on it again or press ESC to close it.
~
73, 27, 134, 46
Technology Report
Click on this scroll or press F6 to bring up the Technology Report.
Click on it again or press ESC to close it.
~
136, 29, 196, 45
Espionage Report
Click on this scroll or press F7 to bring up the Espionage Report.
Click on it again or press ESC to close it.
~
198, 28, 259, 45
Ranking Report
Click on this scroll or press F8 to bring up the Ranking Report.
Click on it again or press ESC to close it.
~
266, 6, 440, 25
Food
...
BUILD
Build
This will enable you to choose a structure to build.
If you do not have enough money to build a structure,
this tile will be disabled.
~
CANCEL
Cancel
...
CHGPROD
Change Production
This will toggle production in this factory between iron,
copper and clay products.
~
COLLTAX
Collect Tax
This will collect tax from the selected village.
If you right-click on this you will be able to tax your
villagers automatically.
~
CONTINUE
Continue
~
...
DEFENSE1
Alert
This orders your troops to sortie whenever the fort or linked
...
GRANT
Grant
This will grant money to the selected village.
If you right-click on this you will be able to grant money automatically.
~
GRANT2
Grant
This will grant money to the selected village to lower the villagers'
loyalty or resistance.
~
HIRECARA
Hire Caravan
This will hire a caravan from this market so that you can conduct trade.
It will be disabled if you have too few villagers to support any more caravans.
10 villagers are needed to support each caravan.
~
HIREUNIT
Hire Person
...
This will invoke a Greater Being who will then appear over your Seat of Power.
This tile will be disabled until you have enough praying points to make invocation possible.
~
MAKESHIP
Build a Ship
...
OUTSHIP
Disembark from Ship
The will disembark all of the units from this ship.
This tile will be disabled if your ship is not close enough to the shore.
~
PATROL
Sortie
...
RECRUIT
Recruit
This will recruit a peasant from the selected village.
For each click, one peasant will exit. This tile will be disabled if
there are no more peasants in the village.
~
RESEARCH
Conduct Research
This orders the start of a research project. This will be disabled
if all possible research has been completed.
~
REWARD
Honors
This will award an honor to the selected person.
For each honor, the person's loyalty will increase by 10 points.
This will be disabled for the King.
~
REWARDCB
Honors
This will award an honor to the selected General or soldier in this fort.
For each honor, the unit's loyalty will increase by 10 points.
This will be disabled for the King.
~
REWARDSP
Honors
This will award an honor to the selected General or prayer in this Seat of Power.
For each honor, the unit's loyalty will increase by 10 points.
This will be disabled for the King.
~
SAILOUT
Sail out of Harbor
This orders the selected ship to sail out of the harbor and await
your further commands.
~
SELBRIBE
Offer Bribe
This takes you to a menu where you can choose the amount of the bribe
to offer to the selected enemy person.
~
SETTLE
Settle
This orders the selected people to settle on vacant land or in
an established village. If this unit is a spy, this tile can also
be used to settle the spy in an enemy's village.
~
SPYMENU
Spy Menu
Go to the spy menu.
...
This orders the selected spy to capture the enemy structure in
which he is located.
~
SPYCHACT
Spy's Task
...
TRAIN
Train
This will train a villager in a selected skill.  This tile will be
disabled if there are no more peasants in the village or
if you do not have a General in a fort linked to the village.
~
VSECRET
View Secrets
This will take you to a menu where you can select the type of
this kingdom's secrets to view. The secrets that you can view will
depend on the skill level of your spy.
~
NOSPY
Drop spy identity
...
This icon shows that there is a construction worker stationed in this structure.
Click or Right-Click on this to mobilize the construction worker.
~
REPLYDIP
...
FC_RAW
Raw Material Stock
This shows the current stock of the raw material used for manufacturing
in this factory. The maximum capacity for storing the stock in a factory
is 500.
~
FC_PROD
Product Stock
This shows the current stock of the finished goods in this factory.
The maximum capacity for storing the stock in a factory is 500.
~
CANCELWP
...
ALLOWATK
Allow Attack
If this is set to "Yes", you will be able to target and attack the units and structures of the selected kingdom.
If it is set to "No", you will not.
~
AGGRESS0
Passive Mode Enabled. Click for Aggressive Mode
When toggled to this mode your units will not fight unless attacked.
If ordered to change location, they will not stop to fight off an attack.
~
AGGRESS1
Aggressive Mode Enabled. Click for Passive Mode
When toggled to this mode your units will automatically attack an enemy in their area, but will not follow it out of the area.
If ordered to change location, they will stop to fight off an attack and then continue.
~
ASSASSIN
Assassinate
...
GODHEAL
Dispense Healing
When you Click on this tile your cursor will change into a large white circle.
Place this circle over your injured units and Click again. Repeat until the Lord of Healing's power has been depleted.
~
GODMIND
Change Loyalty
When you Click on this tile your cursor will change into a large white circle.
Place this circle over your target and Click again. Repeat until the Mind Turner's power has been depleted.
~
GODINCCL
Increase power of Maya Soldiers
When you Click on this tile your cursor will change into a large white circle.
Place this circle over your soldiers and Click again. Repeat until Kukulcan's power has been depleted.
~
GODRAIN
Summon Rain
When you Click on this tile it will cause the rains to come to the whole world.
Repeat until Thor's power has been depleted.
~
GODTORNA
Summon Tornadoes
When you Click on this tile your cursor will change into a small square.
Place this square over your target and Click again. Repeat until Thor's power has been depleted.
